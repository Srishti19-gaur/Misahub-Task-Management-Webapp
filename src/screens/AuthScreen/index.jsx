  ...
  return (
    ...
    >
      <Stack mb={6} spacing={4} alignItems="center" textAlign="center">
        <ImageEl src={LogoImg} alt="MisaHub Task Management App" style={{ width: '175px', height: '75px' }}/>
        <Typography color="rgba(255,255,255, .6)">
          Visualizing the Workflow for Increased Productivity @Misahub.
          <br />
          Accessing the Tasks Anytime, Anywhere
        </Typography>
      </Stack>
      <Stack spacing={2}>
        <TextField
